...
<section>
  <ul class="nav1">
       <li><a title="contact" href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang');?>/support/">Contact Us  </a></li>
        ...
        <li class="highactive"><a title="Troubleshooting" href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/support/Troubleshooting">Troubleshooting</a></li>
      
         </ul>
</section>     
<section> 
 <h1><?php echo lang('Troubleshooting.seven'); ?></h1> 
 <?php echo lang('Troubleshooting.seventxt'); ?>
    </section>    
