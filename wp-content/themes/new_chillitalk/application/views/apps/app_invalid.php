        ...
        <form method="POST">
          <div id="radios1">
                ...
                disabled:'<?php echo get_template_directory_uri(); ?>/img/landlineandmobile.jpg' }" />
                 ...
                 <input type="radio" id="tim2" onclick="toggle('hide');" value="android" checked="checked" title="android" name="group1" class="{src:'<?php echo get_template_directory_uri(); ?>/img/android.png',checked:'<?php echo get_template_directory_uri(); ?>/img/android_select.png',hover:'<?php echo get_template_directory_uri(); ?>/img/android_select.png',disabled:'<?php echo get_template_directory_uri(); ?>/img/android.png'}" />
                 
                     <input type="radio" id="tim3" onclick="toggle('hide');" value="iPhone & iPad" name="group1" disabled="disabled" class="{src:'<?php echo get_template_directory_uri(); ?>/img/iphone2.png', checked:'<?php echo get_template_directory_uri(); ?>/img/iphone2.png', hover:'<?php echo get_template_directory_uri(); ?>/img/iphone2.png', disabled:'<?php echo get_template_directory_uri(); ?>/img/iphone2.png'}" />
              ...
              <section>
                  ...
                  method="post" action="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/apps/invalid">
                      ...
                      <div>
                          ...
                          <input type="text" class="ukflg" value="+<?php echo $this->session->userdata('prefix_phone_web'); ?>" name="UK" readonly="readonly">
                      ...
                      <button type="submit" class="signupimg leftcaed">sign-up</button>
                                        <p >Alternatively, 
                      find Chillitalk in the App Store or Google Play and download our free app straight to your phone.</p>

					</form>
                  </div>
              </section>
                                 <p id="store2">Alternatively, 
                      find Chillitalk in the App Store or Google Play and download our free app straight to your phone.</p>
