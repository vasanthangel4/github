...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/dt_js.js"></script>
  ...
  <body>
   ...
   <!-- <?php if($this->uri->segment('1') == 'fr') { ?>
    <option class="fr" value="fr" selected>French</option>
    <?php }else{ ?>
    <option class="fr" value="fr" >French</option>
    <?php } ?>
    
	<?php if($this->uri->segment('1') == 'de') { ?>
    <option class="de" value="de" selected>German</option>
    <?php }else{ ?>
    <option class="de" value="de">German</option>
    <?php } ?>
    
	<?php if($this->uri->segment('1') == 'se') { ?>
    <option class="se" value="se" selected>Swedish</option>
    <?php }else{ ?>
    <option class="se" value="se">Swedish</option>
    <?php } ?>
    
	<?php if($this->uri->segment('1') == 'dk') { ?>
    <option class="dk" value="dk" selected>Danish</option>
    <?php }else{ ?>
    <option class="dk" value="dk">Danish</option>
    <?php } ?>
  ...
  elseif($this->lang->lang() == 'se') { ?>  <style type="text/css">  #loginimg a, #signupimg a,#loginimg a:hover, #signupimg a:hover, ul.nav li,.topupns  a{font-size:13px !important;}</style>   <?php }
    ...
    <?php } ?>      
               ...
               <ul class="none">
                ...
                <li class="none">
                    <a href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/myaccount/" class="none" title="my account">
        ...
        <nav class="maincomon">
            <ul class="nav rightcom">
              ...
              <li><a href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/support/" title="support"><?php echo lang('header.support'); ?></a> </li>
                  ...
                  <li><a href="<?php echo base_url(); ?><?php echo $this->session->userdata('lang'); ?>/earn_money/"><?php echo lang('header.earn'); ?></a> </li>
                <?php if($this->session->userdata('username') == '') { ?>
                <li class="login none">
